...
export default function GenerationsPage() {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white font-[family-name:var(--font-display)]">Generation History</h1>
        <p className="text-slate-400 mt-1">All your creative generations with quality scores and status.</p>
      </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-white/6">
                <th className="text-left text-xs text-slate-500 font-[family-name:var(--font-display)] px-6 py-3">ID</th>
                ...
                <th className="text-right text-xs text-slate-500 font-[family-name:var(--font-display)] px-6 py-3">Date</th>
              </tr>
            </thead>
            <tbody>
              {GENERATIONS.map((gen) => (
                <tr key={gen.id} className="border-b border-white/4 hover:bg-white/2 transition-colors cursor-pointer">
                  ...
                  <td className="px-6 py-3">
                    <span className="text-sm text-slate-300 truncate block max-w-sm">{gen.prompt}</span>
                  </td>
                  <td className="px-6 py-3">
